...
<html>
    ...
    <body>
        <form class="register" action="" method="POST">
            ...
            <input type="text" name="username" <?php if($username != null) echo "value= $username" ?> 
            <label>Password</label>
            <input type="password" name="password" <?php if($dpassword != null) echo "value= $dpassword" ?>  
            <label>Confirm Password</label>
            <input type="password" name="cpassword" <?php if($cpassword != null) echo "value= $cpassword" ?> 
